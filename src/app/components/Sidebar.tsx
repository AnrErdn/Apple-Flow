...
const Sidebar: React.FC<SidebarProps> = ({ userStatus = 'online', userName = 'Andrei' }) => {
    ...
    return (
        <aside className="bg-white text-[#1d1d1f] w-[288px] min-h-screen h-full border-r-2 border-[#D2D2D7] flex justify-between flex-col overflow-y-auto flex-shrink-0">
            <div>
                {/* Profile Section */}
                ...
                <div className='mt-5 px-4 sm:px-6'>
                    <nav className='space-y-6'>
                        ...
                        <div className='space-y-[18px]'>
                            ...
                            <ul className='ml-0 sm:ml-6 space-y-[18px] text-xs sm:text-sm'>
                                <li>
                                ...
                                <li>
                                    <Link href="/dashboard/marketing" className={navItemClass('/dashboard/marketing')}>
                                        <Megaphone />
                        ...
                        <div className='space-y-[18px]'>
                            ...
                            <ul className='ml-0 sm:ml-6 space-y-[18px] text-xs sm:text-sm'>
                                <li>
                                    <Link href="/help-support/help-center" className={navItemClass('/help-support/help-center')}>
                                        <Info />
                                        <span className="hidden sm:inline">Help Center</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/help-support/account-status" className={navItemClass('/help-support/account-status')}>
                                        <Account />
                                        <span className="hidden sm:inline">Account Status</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/help-support/safety" className={navItemClass('/help-support/safety')}>
                                        <Shield />
                                        <span className="hidden sm:inline">Safety</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/help-support/terms-policies" className={navItemClass('/help-support/terms-policies')}>
                                        <Book />
                        ...
                        <div className='space-y-[18px]'>
                            ...
                            <ul className='ml-0 sm:ml-6 space-y-[18px] text-xs sm:text-sm'>
                                <li>
                                    <Link href="/settings-privacy/settings" className={navItemClass('/settings-privacy/settings')}>
                                        <Settings />
                                        <span className="hidden sm:inline">Settings</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/settings-privacy/privacy-center" className={navItemClass('/settings-privacy/privacy-center')}>
                                        <Lock />
            ...
            <div className='pb-[36px]'>
                <div className='space-y-[24px] sm:space-y-[36px]'>
                    ...
                    <div className='mx-4 sm:mx-6 border-2 border-[#D2D2D7] rounded-[6px] w-auto max-w-[240px] min-h-[141px] hidden sm:block'>
